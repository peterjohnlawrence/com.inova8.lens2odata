...
sap.ui.core.Control.extend("sparqlish.control.conjunctionPropertyClause", {
	...
	init : function() {
		...
		self.setAggregation("_propertyClause", new sparqlish.control.propertyClause({}).bindElement("queryModel>clause").setConjunction(true).attachPropertyClauseChanged(
				function(oEvent) {
