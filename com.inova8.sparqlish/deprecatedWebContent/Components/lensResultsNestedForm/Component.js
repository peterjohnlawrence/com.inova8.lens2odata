...
jQuery.sap.declare("Components.lensResultsNestedForm.Component");

sap.ui.core.UIComponent.extend("Components.lensResultsNestedForm.Component", {
...
Components.lensResultsNestedForm.Component.prototype.createContent = function() {
	var self = this;
...
Components.lensResultsNestedForm.Component.prototype.renderResults = function(query) {
	var self = this;
...
Components.lensResultsNestedForm.Component.prototype.nextFormElement = function(oFormContainer, sLabel, nStartRow, oField) {
	var nRow = nStartRow;
...
Components.lensResultsNestedForm.Component.prototype.bindFormFields = function(oMetaModel, oFormContainer, oTemplate, sCurrentLabel, sCurrentPath, nStartRow) {
	var sEntityType;
	var oEntityType;
	var nRow = nStartRow;
